...
from metrics.predict import predict_HAE, predict_classical_binary_cl, predict_QVC
...
def test_model_task(self, job, test_data, test_labels, path_save="", custom_dict={}):
	...
	predict_cl, labels_cl = predict_classical_binary_cl(test_data=test_data, test_labels=test_labels)
